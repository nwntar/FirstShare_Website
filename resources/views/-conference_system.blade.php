                ...
                <div class="container py-5">
                    <div class="row g-4 justify-content-center ">
                        ...
                        <div style="text-align: center; margin-bottom: 10px;">
                            <button class="btn btn-primary rounded-pill" id="prev-page"><i class="fas fa-arrow-alt-circle-left"></i></button>
                            <button class="btn btn-primary rounded-pill" id="next-page"><i class="fas fa-arrow-alt-circle-right"></i></button>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name="customer"   id="customer" required placeholder="Your Name">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control"   placeholder="Leave a message here" id="address" required name="address" style="height: 160px"></textarea>
                                ...
                                <div class="col-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody style="font-size:14pt">
                                            <tr class="bg-light">
                                                <td colspan="4" class="sub-child-1 fw-bold">Service 1
                                            ...
                                            <tr>
                                                ...
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"   value="5000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 31-50 บทความ   </td>
                                                <td class="text-center">10000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="10000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 51-75 บทความ   </td>
                                                <td class="text-center">15000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="15000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 76-100 บทความ   </td>
                                                <td class="text-center">20000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="20000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 101-150 บทความ   </td>
                                                <td class="text-center">25000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="25000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 151-200 บทความ   </td>
                                                <td class="text-center">30000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="30000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 201-250 บทความ   </td>
                                                <td class="text-center">35000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="35000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 251-300 บทความ   </td>
                                                <td class="text-center">40000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="40000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- มากกว่า 300 บทความ   </td>
                                                <td class="text-center">45000 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_1"  value="45000"  /></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="radio text-center"><input type="radio" name="Package_2_2" value="1000"  /></td>
                                               
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- ผู้ประเมิน 2 คน/บทความ </td>
                                                <td class="text-center">1500 บาท</td>
                                                <td class="radio text-center"><input type="radio" name="Package_2_2" value="1500"  /></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="radio text-center"><input type="radio" name="Package_2_2" value="2000"  /></td>
                                               
                                            </tr>
                                           
                                            <tr class="bg-light">
                                                <td colspan="4" class="sub-child-1 fw-bold">Service  3
                                                ระบบจัดการ Proceedings Online  1000/บทความ</td>
                                            </tr>
                                            <tr class="bg-light">
                                           
                                                <td colspan="4" class="sub-child-1 fw-bold">  &nbsp; &nbsp;จำนวนบทความ 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td> &nbsp; &nbsp;- 1-30 บทความ   </td>
...
<div class="container-fluid   py-5" id="contact">
    <div class="container py-5">
        ...
        <script>
            const url = "{{ URL::asset('pdf/Academic4Share.pdf') }}"; // ระบุเส้นทางไฟล์ PDF
            console.log(url);
