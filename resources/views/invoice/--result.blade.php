        ...
        <main class="px-4">
            <div class="row align-items-center mb-2">
                <div class="col-sm-12 text-center text-sm-start">
                    ...
                    <p style="font-size: 12px; margin-bottom: 0;">เบอร์ติดต่อ: 0987654321</p>
                    <p style="font-size: 12px; margin-bottom: 0;">เลขประจำตัวผู้เสียภาษี: 1236549874568</p>
                    ...
                    <tbody class="align-middle">
                        ...
                        @if ($data['Package_2_1'] != 0)
                            <tr>
                                ...
                                <td style="font-weight: bold;">Package 2 ระบบจัดการบทความ</td>
                                <td class="text-center"></td>
                            </tr>
                            <tr>
                        ...
                        @endif
                           @if ($data['Package_3_1'] != 0)
                            <tr>
                                <td class="text-center"><?php echo $counter++; ?></td> <!-- ใช้ตัวแปรนับลำดับ -->
                                <td style="font-weight: bold;">Package 3 ระบบจัดการ Proceedings Online</td>
                                <td class="text-center"></td>
                            </tr>
                            <tr>
                                <td class="text-center"></td> <!-- ใช้ตัวแปรนับลำดับ -->
                            ...
                            <tr>
                                <td class="text-center"></td> <!-- ใช้ตัวแปรนับลำดับ -->
                                <td style="font-weight: bold;">- ค่าจัดรูปแบบบทความ 800/บทความ </td>
                                <td class="text-center">{{ number_format($data['Package_a'] )}}</td>  
                            </tr>
                              <tr>
                                <td class="text-center"></td> <!-- ใช้ตัวแปรนับลำดับ -->
                                <td style="font-weight: bold;">- ออนไลน์บทความแบบ HTML 200/บทความ</td>
                                <td class="text-center">{{ number_format($data['Package_html'])}}</td>  
                            </tr>
                            @endif
                        ...
                        <table class="table table-sm table-bordered border-dark"
                            ...
                            <tbody class="align-middle">
                                <tr style="background-color: rgb(235, 235, 235)">
                                    ...
                                    <th class="text-" style="width: auto;">{{convertNumberToThaiText($data['totalPrice'])}} </th>
                        ...
                        <table class="table table-sm table-bordered border-dark"
                            ...
                            <tbody class="align-middle">
                                <tr style="background-color: rgb(235, 235, 235)">
                                    ...
                                    <th class="text-" style="width: auto;"> {{number_format($data['totalPrice_Novat'])}}</th>
                                </tr>
                                <tr style="background-color: rgb(235, 235, 235)">
                                ...
                                <tr style="background-color: rgb(235, 235, 235)">
                                    ...
                                    <th class="text-" style="width: auto;"> {{number_format($data['totalPrice'])}}</th>
                                </tr>
