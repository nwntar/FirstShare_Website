...
<div class="container-fluid bg-breadcrumb" id="">
    ...
    <div class="container text-center " style="max-width: 900px;">
        <h4 class="text-white display-4  wow fadeInDown" data-wow-delay="0.1s"><b> เกี่ยวกับเรา </b></h4>
...
<div class="container-fluid " >
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-12  text-center wow fadeInLeft" data-wow-delay="0.1s"> 
                <div class=" wow fadeInLeft" data-wow-delay="0.1s">
                    <div class="h-100 rounded">
                        <h1 class="text-dark"><b>FirstShare: Contemporary Conference Platform</b> </h1> <hr>
                        <h5 class="mb-4"><i class="fas fa-quote-left text-dark"></i>
