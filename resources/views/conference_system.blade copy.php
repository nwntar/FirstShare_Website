                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody style="font-size:14pt">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="radio text-center"><input type="radio" name="Package_1_1"
                                                            value="25000" /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="radio text-center"><input type="radio" name="Package_1_2"
                                                            value="10000" /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="radio text-center"><input type="radio"
                                                            name="Package_2_2" value="1000" /></td>
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="4" class="sub-child-1 fw-bold">Service 3
                                                        ระบบจัดการ Proceedings Online 1000/บทความ<br>
                                                        ส่ง ตรวจ จัดบทความ และเผยแพร่ออนไลน์ พร้อม Article ID, DOI , Server , HTML และหน้าปก Proceedings</td>
                                                </tr>
                                                <tr class="bg-light">

                                                    <td colspan="4" class="sub-child-1 fw-bold">
                                                        <div class="form-floating">
                                                            <input type="number" class="form-control" name="Package_3_1"
                                                                required id="Package_3_1" placeholder="Package_3_1">
                                                            <label for="tex">ระบุจำนวนบทความ</label>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
