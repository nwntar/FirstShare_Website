                ...
                <div class="container-fluid  py-5" id="service1">
                    <div class="container py-5">
                        <div class="row g-4 justify-content-center ">
                            ...
                            <hr>
                            <h5 class="text-dark text-center display-5 mb-4 ">ขอใบเสนอราคา Service 3 </h5>
                                            ...
                                            <tbody style="font-size:14pt">
                                                ...
                                                <tr class="bg-light">
                                                    <td colspan="4" class="sub-child-1 fw-bold">Service 3
                                                        การจัดการรูปแบบบทความและการออนไลน์บทความ <br> 800 บาท ต่อ บทความ <br>
                                                </tr>
                                                 <tr class="">
                                                    <td colspan="4" class="sub-child-1 fw-bold">
                                                        สิ่งที่ผู้ใช้บริการจะได้รับ ส่ง ตรวจ จัดบทความ | และเผยแพร่ออนไลน์ | Article ID | DOI | Server | หน้าปก Proceedings พิเศษสุด!! HTML รายบทความ</td>
                                                </tr>
                                                {{-- <tr class="">
                                                    <td colspan="4" class="sub-child-1 fw-bold">
                                                         - Article ID</td>
                                                ...
                                                <tr class="">
                                                    <td colspan="4" class="sub-child-1 fw-bold">
                                                        - หน้าปก Proceedings</td>
                                                </tr> --}}
                                                <tr class="bg-light">

                                                    <td colspan="4" class="sub-child-1 fw-bold">
                                                        <div class="form-floating">
                                                            <input type="number" class="form-control" required name="Package_3_1"
